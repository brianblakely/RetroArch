...
DEFAULT_TITLE_MACRO(action_get_title_set_patch,                 MENU_ENUM_LABEL_VALUE_SET_PATCH)
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_SET_PATCH:
            BIND_ACTION_GET_TITLE(cbs, action_get_title_set_patch);
            break;
